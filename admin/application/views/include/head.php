...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url("assets/libs/rwd-table/rwd-table.min.css") ?>" rel="stylesheet" type="text/css" />
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div class="navbar-custom">
                ...
                <!-- LOGO -->
                <div class="logo-box">
                    <a href="<?php echo base_url("home")?>" class="logo logo-dark text-center">
                        <span class="logo-lg">
