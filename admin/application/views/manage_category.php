                                                    ...
                                                    <tbody>
                                                        <?php
                                                            ...
                                                            foreach($cat_data as $row) {
                                                                ...
                                                                echo '<td><img src="./upload/category_img/'.$row->image.'" class="data-img row-icon" data-toggle="modal" data-target="#view_image_modal"></td>';
                                                                echo '<td>'. $row->name .'</td>';
                                                                ...
                                                                echo '<td>
                                                                        <div class="btn-group">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                                ...
                                                                                <a class="dropdown-item app-status" href="#" data-row-id="'.$row->cat_id.'" data-table-name="category" data-table-id-field="cat_id" data-table-image-field="image" data-img-path="./upload/category_img/"  data-img-type="icon" data-toggle="modal" data-target="#change_image" onclick = change_image_data(this);>Change Icon</a>
